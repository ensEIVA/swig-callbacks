...
SWIGV8_ClientData _exports_Caller_clientData;
...
static SwigV8ReturnValue _wrap_new_Caller(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  Caller *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Caller.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Caller.");
  result = (Caller *)new Caller();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_Caller, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_Caller(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    Caller * arg1 = (Caller *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_Callback = {"_p_Callback", "p_Callback|Callback *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Caller = {"_p_Caller", "Caller *|p_Caller", 0, 0, (void*)0, 0};
...
/* Name: _exports_Caller, Type: p_Caller, Dtor: _wrap_delete_Caller */
SWIGV8_FUNCTION_TEMPLATE _exports_Caller_class = SWIGV8_CreateClassTemplate("_exports_Caller");
SWIGV8_SET_CLASS_TEMPL(_exports_Caller_clientData.class_templ, _exports_Caller_class);
_exports_Caller_clientData.dtor = _wrap_delete_Caller;
if (SWIGTYPE_p_Caller->clientdata == 0) {
  SWIGTYPE_p_Caller->clientdata = &_exports_Caller_clientData;
}
...
SWIGV8_FUNCTION_TEMPLATE _exports_Caller_class_0 = SWIGV8_CreateClassTemplate("Caller");
_exports_Caller_class_0->SetCallHandler(_wrap_new_Caller);
_exports_Caller_class_0->Inherit(_exports_Caller_class);
v8::Local<v8::Object> _exports_Caller_obj = _exports_Caller_class_0->GetFunction(context).ToLocalChecked();
...
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Caller"), _exports_Caller_obj));
