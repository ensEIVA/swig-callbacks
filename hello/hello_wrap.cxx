...
#define SWIGTYPE_p_std__functionT_void_fF_t swig_types[2]
#define SWIGTYPE_p_std__functionT_void_fintF_t swig_types[3]
...
void runJSCallback() {
    // std::cout << "C++ runJSCallback() called!" << std::endl;

    if (!g_jsCallback) {
        // std::cout << "No JavaScript callback stored!" << std::endl;
        return;
    }
    ...
    if (cb.IsEmpty()) {
        // std::cout << "Callback conversion failed!" << std::endl;
        return;
    }

    // std::cout << "Attempting to call JavaScript callback..." << std::endl;
    
    // Use Try-Catch for additional error information
...
//         std::cout << "JavaScript callback threw an exception: " << *exception << std::endl;
//     } else {
//         std::cout << "JavaScript callback executed successfully!" << std::endl;
//     }
}
...
#define SWIGV8_INIT hello_initialize


SWIGV8_ClientData _exports_Hello_clientData;


static SwigV8ReturnValue _wrap_new_Hello(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  Hello *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Hello.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Hello.");
  result = (Hello *)new Hello();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_Hello, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_Hello_Greet(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Hello_Greet.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Hello, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Hello_Greet" "', argument " "1"" of type '" "Hello *""'"); 
  }
  arg1 = reinterpret_cast< Hello * >(argp1);{
    {
      ...
      if (!SWIG_IsOK(res) || !ptr) {
        SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "Hello_Greet" "', argument " "2"" of type '" "std::string""'"); 
      }
      arg2 = *ptr;
      if (SWIG_IsNewObj(res)) delete ptr;
    }
  }
  (arg1)->Greet(SWIG_STD_MOVE(arg2));
...
static SwigV8ReturnValue _wrap_Hello_SetCallback(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Hello_SetCallback.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Hello, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Hello_SetCallback" "', argument " "1"" of type '" "Hello *""'"); 
  }
  arg1 = reinterpret_cast< Hello * >(argp1);{
    {
      // std::cout << "SWIG typemap: Processing callback..." << std::endl;
      
      if (args.Length() == 0 || !args[0]->IsFunction()) {
        // std::cout << "SWIG typemap: Invalid callback!" << std::endl;
      ...
      // std::cout << "SWIG typemap: Callback stored successfully." << std::endl;
...
static SwigV8ReturnValue _wrap_Hello_SetCallbackWithArg(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Hello_SetCallbackWithArg.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Hello, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Hello_SetCallbackWithArg" "', argument " "1"" of type '" "Hello *""'"); 
  }
  arg1 = reinterpret_cast< Hello * >(argp1);{
    {
      if (args.Length() == 0 || !args[0]->IsFunction()) {
  ...
  (arg1)->SetCallbackWithArg(SWIG_STD_MOVE(arg2));
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_Hello_RunCallback(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Hello_RunCallback.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Hello, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Hello_RunCallback" "', argument " "1"" of type '" "Hello *""'"); 
  }
  arg1 = reinterpret_cast< Hello * >(argp1);(arg1)->RunCallback();
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_Hello_FireCallbacks(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 2 || args.Length() > 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Hello_FireCallbacks.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Hello, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Hello_FireCallbacks" "', argument " "1"" of type '" "Hello *""'"); 
  }
  arg1 = reinterpret_cast< Hello * >(argp1);ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Hello_FireCallbacks" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Hello_FireCallbacks" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);(arg1)->FireCallbacks(arg2,arg3);
  jsresult = SWIGV8_UNDEFINED();
...
static void _wrap_delete_Hello(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    Hello * arg1 = (Hello *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_Hello = {"_p_Hello", "p_Hello|Hello *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__functionT_void_fintF_t = {"_p_std__functionT_void_fintF_t", "std::function< void (int) > *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_Hello,
  &_swigt__p_char,
  &_swigt__p_std__functionT_void_fF_t,
  &_swigt__p_std__functionT_void_fintF_t,
};
...
static swig_cast_info _swigc__p_std__functionT_void_fintF_t[] = {  {&_swigt__p_std__functionT_void_fintF_t, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_Hello,
  _swigc__p_char,
  _swigc__p_std__functionT_void_fF_t,
  _swigc__p_std__functionT_void_fintF_t,
};
...
#endif
{
  ...
  /* Name: _exports_Hello, Type: p_Hello, Dtor: _wrap_delete_Hello */
SWIGV8_FUNCTION_TEMPLATE _exports_Hello_class = SWIGV8_CreateClassTemplate("_exports_Hello");
SWIGV8_SET_CLASS_TEMPL(_exports_Hello_clientData.class_templ, _exports_Hello_class);
_exports_Hello_clientData.dtor = _wrap_delete_Hello;
if (SWIGTYPE_p_Hello->clientdata == 0) {
  SWIGTYPE_p_Hello->clientdata = &_exports_Hello_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_Hello_class, "Greet", _wrap_Hello_Greet);
SWIGV8_AddMemberFunction(_exports_Hello_class, "SetCallback", _wrap_Hello_SetCallback);
SWIGV8_AddMemberFunction(_exports_Hello_class, "SetCallbackWithArg", _wrap_Hello_SetCallbackWithArg);
SWIGV8_AddMemberFunction(_exports_Hello_class, "RunCallback", _wrap_Hello_RunCallback);
SWIGV8_AddMemberFunction(_exports_Hello_class, "FireCallbacks", _wrap_Hello_FireCallbacks);
  ...
  /* class instances */
  /* Class: Hello (_exports_Hello) */
SWIGV8_FUNCTION_TEMPLATE _exports_Hello_class_0 = SWIGV8_CreateClassTemplate("Hello");
_exports_Hello_class_0->SetCallHandler(_wrap_new_Hello);
_exports_Hello_class_0->Inherit(_exports_Hello_class);
v8::Local<v8::Object> _exports_Hello_obj = _exports_Hello_class_0->GetFunction(context).ToLocalChecked();
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Hello"), _exports_Hello_obj));
...
NODE_MODULE(hello, hello_initialize)
#else
NODE_MODULE_CONTEXT_AWARE(hello, hello_initialize)
#endif
#endif
